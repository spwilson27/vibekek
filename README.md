...
docs/plan/requirements.json  # Master requirements list
```
...
| 4B | Merge into master requirements + scope gate | `docs/plan/requirements.json` |
| 4C | Order requirements by dependency | `docs/plan/requirements.json` (reordered) |
...
```bash
python .tools/verify_requirements.py --verify-req-format docs/plan/requirements.json
```
...
```bash
# Open docs/plan/requirements.json in $EDITOR
