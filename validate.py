...
def validate_phase_18(state: Dict) -> List[str]:
    ...
    # Feature gate producer tracking is available for downstream validation
...
VALIDATORS = {
    ...
    "tasks_completed": ("Phase 15: Holistic Tasks", validate_phase_16),
...
def main() -> None:
    ...
    phase_to_keys = {
        ...
        11: "requirements_ordered",
        12: "epics_completed",
        15: "tasks_completed",
        16: "tasks_reviewed",
        17: "cross_phase_reviewed",
        19: "dag_completed",
    }
