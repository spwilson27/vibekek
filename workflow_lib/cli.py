...
from .runners import GeminiRunner, ClaudeRunner, CopilotRunner, OpencodeRunner, ClineRunner
...
def main() -> None:
    ...
    shared.add_argument("--backend", choices=["gemini", "claude", "opencode", "copilot", "cline"], default=None, help="AI CLI backend to use (default: gemini)")
